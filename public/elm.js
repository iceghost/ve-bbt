...
var $author$project$Main$Model = F2(
	function (rawInput, output) {
		return {output: output, rawInput: rawInput};
	});
...
var $author$project$Table$Nothing = {$: 'Nothing'};
...
var $author$project$Table$ExpectingBracket = F2(
	function (a, b) {
		return {$: 'ExpectingBracket', a: a, b: b};
	});
var $author$project$Table$StuckAt = F2(
	function (a, b) {
		return {$: 'StuckAt', a: a, b: b};
	});
...
try {
	...
	throw 'Some top-level definitions from `Table` are causing infinite recursion:\n\n  ┌─────┐\n  │    groupParser\n  └─────┘\n\nThese errors are very tricky, so read https://elm-lang.org/0.19.1/bad-recursion to learn how to fix it!';}
...
var $author$project$Table$parse = function (text) {
	...
	if (_v0.$ === 'Ok') {
		...
		if (_v0.a.b) {
			...
			while (true) {
				switch (_v2.$) {
					case 'ExpectingSymbol':
						if (_v2.a === ')') {
							return $elm$core$Result$Err(
								A2($author$project$Table$ExpectingBracket, error.col, error.row));
						} else {
							break _v2$2;
						}
					case 'Problem':
			...
			return $elm$core$Result$Err(
				A2($author$project$Table$StuckAt, error.col, error.row));
		} else {
			return $elm$core$Result$Err(
...
var $author$project$Table$All = {$: 'All'};
	...
	function (msg, model) {
		...
		return _Utils_Tuple2(
			_Utils_update(
				model,
				{
					output: $author$project$Main$outputPipe(newInput),
					rawInput: newInput
				}),
			...
			[
					...
					[
						...
						_List_fromArray(
							[
								...
								$elm$html$Html$Attributes$href('https://latex.codecogs.com/png.latex?\\dpi{300} \\bg_white ' + model.output),
				...
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
								$elm$html$Html$text('Made with love by iceghost    ')
							]))
					]))
			]));
};
...
_Platform_export({'Main':{'init':$author$project$Main$main(
	$elm$json$Json$Decode$succeed(_Utils_Tuple0))({"versions":{"elm":"0.19.1"},"types":{"message":"Main.Msg","aliases":{},"unions":{"Main.Msg":{"args":[],"tags":{"GotInput":["String.String"]}},"String.String":{"args":[],"tags":{"String":[]}}}}})}});
